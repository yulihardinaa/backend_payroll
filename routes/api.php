...
Route::put('/dosen/{nik}','DosenController@update');
Route::delete('/dosen/{nik}','DosenController@delete');

Route::get('/staff','StaffController@index');
Route::post('/staff','StaffController@create');
Route::put('/staff/{nik}','StaffController@update');
Route::delete('/staff/{nik}','StaffController@delete');
